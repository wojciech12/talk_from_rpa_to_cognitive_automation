## From Robot Process Automation to Cognitive Automation [PL]
...
<!--
Zacząłem od powstania SMACC.io (CFO-as-a-Service) i skalowania naszej usługi. O ograniczeniach w technologii, które przyśpieszyły naszą transformację do firmy specjalizującej się w uczeniu maszynowym w kontekście procesów finansowych (ekstrakcja dokumentów w szczególności). Po drodze zmiany w naszym SaaS (skupienie się na A/P, walidacji oraz integracji) i utworzenie bliźniaczej firmy technologicznej Hypatos.ai (API onCloud i onPrem, Hypatos Studio; projekty pod klienta). 
-->
